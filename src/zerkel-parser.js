...
break;
case 10:this.$ = "_helpers['match'](" + $$[$0-2] + "," + $$[$0] + ")";
break;
case 11:this.$ = $$[$0];
break;
...
rules: [/^(?:\s+)/,/^(?:and|AND\b)/,/^(?:or|OR\b)/,/^(?:not|NOT\b)/,/^(?:=)/,/^(?:<>)/,/^(?:<=|>=|<|>)/,/^(?:contains|CONTAINS\b)/,/^(?:like|LIKE\b)/,/^(?:[\-0-9]+([0-9]+)*)/,/^(?:"[^\"]*")/,/^(?:[\$A-Za-z_]+(\.[A-Za-z_]+)*)/,/^(?:\()/,/^(?:\))/,/^(?:$)/],
