  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_contains() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, left, right) { return "(" + left + "&&" + left + ".indexOf(" + right + ")" + " >= 0)"; })(pos0, result0[0], result0[4]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_var() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, letters) { return "_env['" + letters.join("") + "']"; })(pos0, result0);
        }
        if (result0 === null) {
          pos = pos0;
        }
